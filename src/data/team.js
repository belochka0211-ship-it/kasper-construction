...
export const team = [
  { name: { uk: 'Артем Ковальчук', en: 'Artem Kovalchuk', ru: 'Артём Ковальчук' }, role: { uk: 'Засновник, CEO', en: 'Founder, CEO', ru: 'Основатель, CEO' }, photo: ph('1507003211169-0a1dd7228f2d') },
